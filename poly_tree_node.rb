module Searchable
  # I wrote this in a module in case I wanted to later write another
  # TreeNode class (e.g., BinaryTreeNode). All I need is a `#children`
  # method for `Searchable` to work.
